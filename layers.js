...
function drawStaticBackground() {
    ...
    function loadGrass() {
        loadImage('https://fintech.tinkoff.ru/static/images/js_game/glass_back.png').then(function(result) {
            GlassBackImage = result;
            loaded++;
        });

        loadImage('https://fintech.tinkoff.ru/static/images/js_game/grass.png').then(function(result) {
            GrassImage = result;
            loaded++;
        });

        loadImage('https://fintech.tinkoff.ru/static/images/js_game/glass_front.png').then(function(result) {
